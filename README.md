...
- Right-click a file or folder to rename or delete it (delete asks first), in either tree. On the remote tree, Download copies a file to a location you pick, or a whole folder into a directory you pick — local files that already exist are left alone and counted as skipped.
